...
def attack(char_name: str, char_class: str) -> str:
    """Генерирует случайно размер урона от атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Генерирует случайно размер защиты."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не применил блокировал урон')


def special(char_name: str, char_class: str) -> str:
    """Геренирует случайно уровень специального умения."""
    if char_class == 'warrior':
